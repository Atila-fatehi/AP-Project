...
public abstract class OrbManager {
    public static void laser() {
        ...
        int size = 100;
        GameState.lasers.add(new Laser(new double[]{x[0] + 20, x[0] + size - 10, x[1] + size - 10, x[1] + 10},
                new double[]{y[0] + 10 + size / 2, y[0] + 10 + size / 2, y[1] + 10 + size / 2, y[1] + 10 + size / 2}, 10));
        GameState.lasers.add(new Laser(new double[]{x[0] + 20, x[0] + size - 10, x[2] + size - 20, x[2] + 10},
                new double[]{y[0] + 10 + size / 2, y[0] + 10 + size / 2, y[2] + 10 + size / 2, y[2] + 10 + size / 2}, 2 * 10));
        GameState.lasers.add(new Laser(new double[]{x[0] + 20, x[0] + size - 20, x[3] + size - 20, x[3] + 10},
                new double[]{y[0] + 10 + size / 2, y[0] + 10 + size / 2, y[3] + 10 + size / 2, y[3] + 10 + size / 2}, 3 * 10));
        GameState.lasers.add(new Laser(new double[]{x[0] + 20, x[0] + size - 10, x[4] + size - 10, x[4] + 10},
                new double[]{y[0] + 10 + size / 2, y[0] + 10 + size / 2, y[4] + 10 + size / 2, y[4] + 10 + size / 2}, 4 * 10));


        GameState.lasers.add(new Laser(new double[]{x[1] + 20, x[1] + size - 20, x[2] + size - 20, x[2] + 10},
                new double[]{y[1] + 10 + size / 2, y[1] + 10 + size / 2, y[2] + 10 + size / 2, y[2] + 10 + size / 2}, 12));
        //12

        GameState.lasers.add(new Laser(new double[]{x[1] + 20, x[1] + size - 10, x[3] + size - 10, x[3] + 10},
...
//14
        ...
        GameState.lasers.add(new Laser(new double[]{x[4] + 20, x[4] + size - 20, x[3] + size - 20, x[3] + 10},
